    ...
    <section className="border-y border-slate-200/80 py-16 dark:border-slate-800 sm:py-20">
      <div className="container-page">
        <FadeIn className="flex flex-col items-center text-center">
          ...
          <h2 className="mt-4 text-lg font-bold text-primary-900 dark:text-white sm:text-xl">
            Accredited & standards-aligned
          </h2>
          <p className="mt-2 max-w-lg text-sm text-slate-500">
            Our programs align with internationally recognized certification frameworks.
          </p>
        </FadeIn>
        <FadeIn delay={0.1}>
